...
#install env
wget -O /opt/marzban/.env "https://raw.githubusercontent.com/mjoeyx/MarMJC/main/env"
...
wget -O /usr/bin/profile "https://raw.githubusercontent.com/mjoeyx/MarMJC/main/profile";
chmod +x /usr/bin/profile
apt install neofetch -y
wget -O /usr/bin/cekservice "https://raw.githubusercontent.com/mjoeyx/MarMJC/main/cekservice.sh"
chmod +x /usr/bin/cekservice

#install compose
wget -O /opt/marzban/docker-compose.yml "https://raw.githubusercontent.com/mjoeyx/MarMJC/main/docker-compose.yml"

#Install VNSTAT
apt -y install vnstat
/etc/init.d/vnstat restart
apt -y install libsqlite3-dev
wget https://github.com/mjoeyx/MarMJC/raw/main/vnstat-2.6.tar.gz
...
wget -O /opt/marzban/nginx.conf "https://raw.githubusercontent.com/mjoeyx/MarMJC/main/nginx.conf"
wget -O /opt/marzban/default.conf "https://raw.githubusercontent.com/mjoeyx/MarMJC/main/vps.conf"
wget -O /opt/marzban/xray.conf "https://raw.githubusercontent.com/mjoeyx/MarMJC/main/xray.conf"
mkdir -p /var/www/html
echo "<pre>Setup by AutoScript MJC-VPN</pre>" > /var/www/html/index.html
...
wget -O /var/lib/marzban/xray_config.json "https://raw.githubusercontent.com/mjoeyx/MarMJC/main/xray_config.json"
...
#install database
wget -O /var/lib/marzban/db.sqlite3 "https://github.com/mjoeyx/MarMJC/raw/main/db.sqlite3"
...
echo "-=================================-" | tee -a /root/log-install.txt
echo "Jangan lupa join Channel & Bot Telegram saya juga di" | tee -a /root/log-install.txt
echo "Telegram Channel: https://t.me/mjcx0" | tee -a /root/log-install.txt
echo "Telegram MultiBot: https://t.me/romjcbot" | tee -a /root/log-install.txt
echo "-=================================-" | tee -a /root/log-install.txt
colorized_echo green "Script telah Berhasil di install"
rm /root/mar.sh
colorized_echo blue "Menghapus admin dari db.sqlite"
marzban cli admin delete -u admin -y
echo -e "[\e[1;31mWARNING\e[0m] Reboot 1x agar tidak error [default y](y/n)? "
read answer
