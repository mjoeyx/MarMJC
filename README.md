...
Ini adalah [Marzban](https://github.com/Gozargah/Marzban) yang sudah di tambahkan nginx untuk konfigurasi koneksi WebSocket, HTTP Upgrade dan gRPC single port. </br>
...
Pastikan anda sudah login sebagai root sebelum menjalankan perintah dibawah
 ```html
 wget https://raw.githubusercontent.com/mjoeyx/MarMJC/main/mar.sh && chmod +x mar.sh && ./mar.sh
 ```
...
![image](https://github.com/mjoeyx/MarMJC/assets/97426017/3aeedf09-308e-41b0-9640-50e4abb77aa0) </br>
...
Join ke Telegram channel saya di :<a href="https://t.me/mjcx0" target=”_blank”><img src="https://img.shields.io/static/v1?style=for-the-badge&logo=Telegram&label=Telegram&message=Click%20Here&color=blue"></a><br>
